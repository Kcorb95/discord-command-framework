...
class Command {
    ...
    constructor(client, info) {
        ...
        /**
         * Whether the command is whitelist only
         * @type {boolean}
         */
        this.whitelist = info.whitelist || { roles: false, channels: false };
    ...
    setEnabledIn(guild, enabled, type) {
        ...
        guild.setCommandEnabled(this, enabled, type);
    }

    /**
     * Checks if the command is enabled in a guild
     * @param {?Message} message - The message
     * @param {?permission} target - The message
     * @return {boolean}
     */
    isEnabledIn(message) {
        ...
        if (!message) return this.group._globalEnabled && this._globalEnabled;
        guild = this.client.guilds.resolve(guild);
        return guild.isGroupEnabled(this, message) && guild.isCommandEnabled(this, message);
    }
    ...
    isUsable(message = null) {
        ...
        return this.isEnabledIn(message) && hasPermission && typeof hasPermission !== 'string';
    }
