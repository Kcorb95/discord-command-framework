declare module 'discord.js-commando' {
    ...
    import {Database as SQLDatabase, Model as SequelizeModel} from "sequelize";
    ...
    export class CommandoClient extends Client {
        ...
        on(event: 'commandWhitelistChange', listener: (guild: Guild, command: Command, enabled: boolean, type: string) => void): this;
    ...
    export class CommandoGuild extends Guild {
        ...
        private _commandsEnabledChannels: object;
        private _commandsEnabledRoles: object;
        private _groupsEnabled: object;
        private _groupsEnabledChannels: object;
        private _groupsEnabledRoles: object;
        ...
        public isCommandEndabledInChannel(command: CommandResolvable): boolean;

        public isCommandEndabledInRole(command: CommandResolvable): boolean;

        public isGroupEnabled(group: CommandGroupResolvable): boolean;

        public isGroupEnabledInChannel(group: CommandGroupResolvable): boolean;

        public isGroupEnabledInRole(group: CommandGroupResolvable): boolean;
    ...
    export class SettingProvider {
        ...
        public set(guild: Guild | string, key: string, val: any, type: any): Promise<any>;
